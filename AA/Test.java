...
public class Test{
    public static void main(String[] args) {
        ...
        PcFisso_Desktop p3 = new PcFisso_Desktop("Intel Core i7", 16, "512 GB SSD", "HP", "EliteDesk", "Windows 10 Pro", "Nvidia GeForce RTX 3070", "Realtek HD Audio","case"); 
        System.out.println(p3);

        PcFisso_Server p4 = new PcFisso_Server("Intel Xeon E5-2620 v4", 32, "4 TB HDD", "Dell", "PowerEdge", "Windows Server 2019", 2, true,"case");     
