public class Main{
    ...
    public static void Main(String[] args) {
        PC pc1 = new PC("Intel Core i5", 8, 512, "Dell", "Inspiron", "Windows 10");
        ...
        PcPortatili_Palmari pc5 = new PcPortatile_Palmari("Qualcomm Snapdragon 865", 6, 256, "Samsung", "Galaxy Tab S7", "Android 11", 500, 5, "microSD");
